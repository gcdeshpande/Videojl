...
# !!! Main.UserApp is configured as an alias for Main.JuliaVideos and you might encounter it in some tests
using Main.JuliaVideos, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaVideos tests" begin
  @includetests ARGS
end
